...
:::{grid-item-card} **FastMapping**
:link: run-fastmapping-algorithm
:link-type: doc
:link-alt: clickable cards
...
:::{grid-item-card} **ADBSCAN Follow-me**
:link: adbscan-follow-me
:link-type: doc
:link-alt: clickable cards
...
:::{grid-item-card} **GPU ORB Extractor**
:link: orb-extractor
:link-type: doc
:link-alt: clickable cards
