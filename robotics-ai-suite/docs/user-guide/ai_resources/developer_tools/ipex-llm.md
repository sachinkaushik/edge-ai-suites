...
> **Support for Intel® LLM Library for PyTorch has been discontinued in favor of PyTorch XPU, which enables Intel GPU access for PyTorch operations. More information is available at [PyTorch XPU](https://docs.pytorch.org/docs/2.13/notes/get_start_xpu.html)
...
[Model List](https://github.com/intel/ipex-llm/blob/main/README.md#verified-models) shows the optimized/verified models on IPEX-LLM with state-of-art LLM optimizations, XPU acceleration and low-bit (FP8/FP6/FP4/INT4) support.
...
Before installing Intel® LLM Library for PyTorch, ensure to complete the environment setup in [Get Started](../../platform_foundation/getting_started.md) and have Intel® oneAPI™ Base Toolkit installed.
